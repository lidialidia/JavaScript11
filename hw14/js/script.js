...
const appendLi = (value) => {
  ...
  li.innerHTML = `<span class="collection__text">${value}</span><span class="collection__btns"><i class="fa fa-remove delete-item"></i> <i class="fa fa-edit edit-item"></i></span>`;
  taskList.append(li);
};
...
const editTask = (event) => {
    ...
    event.target.parentElement.parentElement.querySelector('.collection__text').innerHTML = `${newTask}`;
